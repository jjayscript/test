...
public class cn_activity {

	private String cn_activity_id;
	private String cn_activity_title;
	private String cn_activity_body;
	private Timestamp cn_activity_end_time;
	public cn_activity() {
		super();
	}
	public cn_activity(String cn_activity_id, String cn_activity_title, String cn_activity_body,
			Timestamp cn_activity_end_time) {
		super();
	...
	public Timestamp getCn_activity_end_time() {
		return cn_activity_end_time;
	}
	public void setCn_activity_end_time(Timestamp cn_activity_end_time) {
		this.cn_activity_end_time = cn_activity_end_time;
	}
